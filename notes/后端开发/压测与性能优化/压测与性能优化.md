...
![1694753288304](imgs/1694753288304.png)



嵌入式的tomcat配置

![1694753319954](imgs/1694753319954.png)
...
访问 ip:port/actuator 可以查看所有配置

![1694754291470](imgs/1694754291470.png)

找到configprops，搜索tomcat查看是否配置成功